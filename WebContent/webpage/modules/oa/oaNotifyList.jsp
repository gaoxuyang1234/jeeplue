		...
		<c:forEach items="${page.list}" var="oaNotify">
			<tr>
				...
				<c:if test="${!requestScope.oaNotify.self}">
    				...
    				<shiro:hasPermission name="oa:oaNotify:del">
						<a href="${ctx}/oa/oaNotify/delete?id=${oaNotify.id}" onclick="return confirmx('确认要删除该通知吗？', this.href)"   class="btn btn-danger btn-xs btn-circle"><i class="fa fa-trash"></i>删除</a>
					</shiro:hasPermission>
				</c:if>
				</td>
			</tr>
