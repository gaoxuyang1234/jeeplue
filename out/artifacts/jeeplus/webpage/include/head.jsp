...
<!-- 引入bootstrap-select -->
<link rel="stylesheet" type="text/css" href="${ctxStatic}/bootstrap-select/bootstrap-select.min.css">
<script type="text/javascript" src="${ctxStatic}/bootstrap-select/bootstrap-select.min.js"></script>
